...
public class Util {
	 ...
	 private static final Logger LOGGER = LoggerFactory.getLogger(Util.class);
	    ...
	    public void explicitlyWaitForFrame(WebDriver driver, WebElement locator) {
	        try {
	            WebDriverWait wait = (WebDriverWait) new WebDriverWait(driver, Duration.ofSeconds(TIME_OUT_IN_SECONDS));
	            wait.ignoring(StaleElementReferenceException.class);
	     ...
	     * @param locator web element to identify
	     */
	    public void handleException(org.openqa.selenium.TimeoutException e, WebElement locator) {
